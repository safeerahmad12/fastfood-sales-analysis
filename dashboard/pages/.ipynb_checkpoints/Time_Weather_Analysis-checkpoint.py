...
with col1:
    ...
    title_suffix = f" ({selected_weather})" if selected_weather != "All" else " (all weather)"
    fig_hour = style_fig(fig_hour, f"Revenue by Hour{title_suffix}")

    st.plotly_chart(fig_hour, width="stretch")

# -----------------------------------------------------
# TEMPERATURE VS ORDER REVENUE
# -----------------------------------------------------
with col2:
    st.markdown(
    ...
    fig_temp = style_fig(fig_temp, "Effect of temperature on revenue")
